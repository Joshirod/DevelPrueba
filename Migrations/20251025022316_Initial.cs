        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SlugPublico = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    CreadoPorUserId = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RespuestaValores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RespuestaValores_Campos_CampoId",
                        column: x => x.CampoId,
                        principalTable: "Campos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RespuestaValores_Respuestas_RespuestaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Campos_EncuestaId_Nombre",
                table: "Campos",
                columns: new[] { "EncuestaId", "Nombre" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Campos_EncuestaId_Orden",
                table: "Campos",
                columns: new[] { "EncuestaId", "Orden" });

            migrationBuilder.CreateIndex(
                name: "IX_Encuestas_SlugPublico",
                table: "Encuestas",
                column: "SlugPublico",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RespuestaValores_CampoId",
                table: "RespuestaValores",
                column: "CampoId");

            migrationBuilder.CreateIndex(
                name: "IX_RespuestaValores_RespuestaId",
                table: "RespuestaValores",
                column: "RespuestaId");
        }
